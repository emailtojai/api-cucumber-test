Feature: Test Customer API Feature Scenarios
  ...
  Scenario Outline: <scenario>
    ...
    Examples:
      ...
      | Create new customer with numeric            |  {"fname": "2345123", "lname": "542342","addresses": [{"address": "321, Sliver rd","city": "Ashland","state": "NY","zip": "98654"}]}  | /customers      | 300         | 2345123         | 542342  |
